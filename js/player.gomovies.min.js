...
function get_episodes() {
    $['ajax']({
        ...
        dataType: 'json',
        async: false,
        success: function(_0x3bf5x12) {
            $('#list-eps')['html'](_0x3bf5x12['html'])
        }
    })
}
...
function load_server() {
    if ($('#sv-' + sv_default)['length'] > 0) {
        ...
        $('.server-item')['each'](function(_0x3bf5x14) {
            if (_0x3bf5x14 === 0) {
...
function player_error() {
    ...
    var _0x3bf5x16 = false;
    $('.server-item.vip')['each'](function(_0x3bf5x14) {
...
function load_embed() {
    if ($('#sv-' + eb_default)['length'] > 0) {
        ...
        $('.server-item.embed')['each'](function(_0x3bf5x14) {
            if (_0x3bf5x14 == 0) {
                sv = $(this)['attr']('data-id');
                return false
            }
...
function change_url() {
    var _0x3bf5x19 = loc['protocol'] + '//' + loc['hostname'] + loc['pathname'] + '?ep=' + eid;
    history['pushState']({}, '', _0x3bf5x19)
}
...
function get_embed() {
    $['ajax']({
        ...
        dataType: 'json',
        success: function(_0x3bf5x12) {
            $('#iframe-embed')['attr']('src', _0x3bf5x12['src'])
        }
    })
}
...
function setup_player() {
    ...
    player['setup'](_0x3bf5x1e);
    player['on']('setupError', function(_0x3bf5x1f) {
        player_error();
        setup_error = true
    });
    player['on']('ready', function() {
        setup_error = false;
        var _0x3bf5x20 = onetwothree['mobileChecker']();
        if (!_0x3bf5x20) {
    ...
    player['on']('complete', function() {
        if ($('#sv-' + sv + ' .ep-item')['length'] > 1 && auto_next) {
            var _0x3bf5x21 = get_ep_index();
            _0x3bf5x21 += 1;
            $('#sv-' + sv + ' .ep-item[data-index=' + _0x3bf5x21 + ']')['click']()
        }
    });
    ...
    player['on']('time', function() {
        ...
        var _0x3bf5x20 = onetwothree['mobileChecker']();
        if (!_0x3bf5x20) {
            var _0x3bf5x22 = onetwothree['adTime']();
            if (parseInt(player['getPosition']()) === _0x3bf5x22['start'] && !ad_is_shown) {
                onetwothree['addTag']();
                ad_is_shown = true
            };
            if (parseInt(player['getPosition']()) === _0x3bf5x22['end'] && ad_is_shown) {
                onetwothree['removeTag']()
            }
        }
    });
    player['on']('error', function(_0x3bf5x1f) {
        player_error()
    })
}

function convert_time(_0x3bf5x24) {
    var _0x3bf5x25 = new Date(0, 0, 0);
    _0x3bf5x25['setSeconds'](+_0x3bf5x24);
    var _0x3bf5x26 = _0x3bf5x25['getHours']();
    var _0x3bf5x27 = _0x3bf5x25['getMinutes']();
    var _0x3bf5x28 = _0x3bf5x25['getSeconds']();
    return (_0x3bf5x26 < 10 ? ('0' + _0x3bf5x26) : _0x3bf5x26) + ':' + (_0x3bf5x27 < 10 ? ('0' + _0x3bf5x27) : _0x3bf5x27) + ':' + (_0x3bf5x28 < 10 ? ('0' + _0x3bf5x28) : _0x3bf5x28)
}
...
$(document)['ready'](function() {
    ...
    setTimeout(function() {
        if (!$['cookie']('view-' + mid)) {
            $['ajax']({
                ...
                success: function(_0x3bf5x12) {
                    var _0x3bf5x29 = new Date();
                    var _0x3bf5x27 = 10;
                    _0x3bf5x29['setTime'](_0x3bf5x29['getTime']() + (_0x3bf5x27 * 60 * 1000));
    ...
    $('#report-form')['submit'](function(_0x3bf5x1f) {
        $('#report-error')['hide']();
        if (($('#report-form input[name*=\'issue\']:checked')['length']) <= 0) {
            ...
            if (!$['cookie']('report-' + eid)) {
                ...
                $('#report-loading')['show']();
                var _0x3bf5x2a = $(this)['serializeArray']();
                _0x3bf5x2a['push']({
